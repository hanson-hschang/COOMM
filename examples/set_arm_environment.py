...
class ArmEnvironment:
    ...
    def set_arm(self):
        ...
        self.set_drag_force(
            base_length, radius[0], radius[-1], self.shearable_rod, self.rod_parameters_dict
        )
    ...
    def set_rod(self):
        ...
        self.simulator.collect_diagnostics(self.shearable_rod).using(
            RodCallBack, step_skip=self.step_skip, callback_params=self.rod_parameters_dict
        )
    ...
    def set_muscles(self, base_radius, arm):
        ...
        self.muscle_callback_params_list = [defaultdict(list) for _ in self.muscle_groups]
    ...
    def set_drag_force(self, base_length, base_radius, tip_radius, arm, arm_parameters_dict):
        """Add drag force"""
